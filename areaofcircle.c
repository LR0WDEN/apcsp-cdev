...
printf("The area of circle with radius 5.2 is %f\n", areaOfCircle(start));
printf("The area of circle with radius 6.2 is %f\n", areaOfCircle(start + 1));
printf("The area of circle with radius 7.2 is %f\n", areaOfCircle(start + 2));
